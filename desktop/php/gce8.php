				...
				<form class="form-horizontal">
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Port de la carte}}
									<sup><i class="fas fa-question-circle tooltips" title="{{En général ttuUSBxx}}"></i></sup>
								</label>
								<div class="col-sm-6">
...
<?php include_file('desktop', 'gce8', 'js', 'gce8'); ?>
